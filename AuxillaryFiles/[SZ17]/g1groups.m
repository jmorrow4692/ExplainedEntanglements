...
load "~/Classification_of_Entanglements/AuxillaryFiles/[SZ17]/g0groups.m";      // creates sl2tab and gl2tab populated with genus zero groups, here we add genus one groups
load "~/Classification_of_Entanglements/AuxillaryFiles/[SZ17]/JacobianRank.m";  // contains JacobianOfXG, used to determine genus one groups G for which Jac(X_G) has positive rank
